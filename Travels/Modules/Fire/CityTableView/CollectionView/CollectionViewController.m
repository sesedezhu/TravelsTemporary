...
- (UITableView *)tableView
{
    if (!_tableView)
    {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, kLeftTableViewWidth, [UIScreen mainScreen].bounds.size.height)];
...
- (UICollectionView *)collectionView
{
    if (!_collectionView)
    {
        _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(kCollectionViewMargin + kLeftTableViewWidth, kCollectionViewMargin, kScreenWidth - kLeftTableViewWidth - 2 * kCollectionViewMargin,  kScreenHeight- 2 * kCollectionViewMargin) collectionViewLayout:self.flowLayout];
...
{
    return CGSizeMake(([UIScreen mainScreen].bounds.size.width - kLeftTableViewWidth - 4 * kCollectionViewMargin) / 2,
                      ([UIScreen mainScreen].bounds.size.width - kLeftTableViewWidth - 4 * kCollectionViewMargin) / 2 + 30);
}
